...
pub fn all_tools() -> Vec<McpTool> {
    vec![
        McpTool {
            ...
            description: "Store a document in layerzero memory with automatic embedding. Optionally scope to a database/collection.".into(),
        ...
        McpTool {
            ...
            description: "Get statistics about the layerzero memory store. Pass database/collection to scope the counts.".into(),
            input_schema: serde_json::json!({
                "type": "object",
                "properties": {
                    "database": db_col_props()["database"].clone(),
